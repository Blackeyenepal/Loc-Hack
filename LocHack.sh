...
| |      | (   ) || |                    | (   ) || (   ) || |      | |\ \          
| (____/\| \__ ) || (____/\              | )   ( || )   ( || (____/\| | \ \         
(_______/ \ ____/ (_______/              |/     \||/     \|(_______/( )  \ ) ARJUN  

www.mrarjun.epizy.com | youtube.com/Blackeyenepal 

''' + W)
	print('\n' + G + '[>]' + C + ' Created By : ' + W + 'Arjun Adhikari ')
	print(G + '[>]' + C + ' Version    : ' + W + version + '\n')

def ver_check():
	print(G + '[+]' + C + ' Checking for Updates.....', end='')
	ver_url = 'https://raw.githubusercontent.com/Blackeyenepal/LocHack/master/version.txt'
	try:
